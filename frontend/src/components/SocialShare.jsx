...
const SocialShare = ({ title = "Share Planet Calm with others", className = "" }) => {
  ...
  const handleShare = (link) => {
    if (link.isInstagram) {
      // Instagram doesn't have direct sharing API, show message
      alert('Instagram doesn\'t support direct web sharing. Please:\n\n1. Take a screenshot of the map\n2. Open Instagram app\n3. Share the screenshot with our link: ' + shareUrl);
      return;
    }
  ...
  return (
    <div className={`social-share ${className}`}>
      {title && <h4 className="social-share-title">{title}</h4>}
